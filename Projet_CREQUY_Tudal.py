# -*- coding: utf-8 -*-
"""
Programme pour les questions 3 et 4 du Projet d'Analyse Numérique Matricielle
sur le modele d'antennes.

Groupe de Projet : Mariama Mbaye (Partie 1 : Questions 1 et 2)
                   Zeynep Balikci (Partie 3 : Questions 5 et 6)
                   Tudal Créquy (Partie 2 : Questions 3 et 4)

Structure du fichier :
    - Fonctions issues des TP pour la résolution par solveur direct en utilisant
      la méthode LU
    - Programme de résolution par la méthode LU
    - Fonctions des différentes Etapes de l'algorithme étudié dans la question 4
    - Programme de résolution à l'aide de ces fonctions
    
N.B. : Le Programme pour les questions 5 et 6 est rendu séparément
